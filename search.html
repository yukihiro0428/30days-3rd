...
<head>
	...
	<title>「タイトル」の検索結果</title>
	<meta name="description" content="">

	<meta property="og:title" content="「タイトル」の検索結果">
	<meta property="og:type" content="website">
	<meta property="og:url" content="https://example.com/search/a/">
	<meta property="og:image" content="https://example.com/search/a/img/ogp.png">
	<meta property="og:site_name" content="「タイトル」の検索結果">
		...
		<div class="inner">
			...
			<main id="primary">
				...
				<div class="breadcrumb">
					...
					<span class="current-item">「タイトル」の検索結果</span>
				</div><!-- /breadcrumb -->
	...
	<div class="footer-sns">
		<div class="inner">
			...
			<nav class="footer-sns-buttons">
				<ul>
					<li><a class="m_twitter" href="https://twitter.com/share?url=https://example.com/search/a/&text=「タイトル」の検索結果"
							rel="nofollow" target="_blank"><img src="img/icon-twitter.png" alt=""></a></li>
					<li><a class="m_facebook" href="https://www.facebook.com/share.php?u=https://example.com/search/a/"
							rel="nofollow" target="_blank"><img src="img/icon-facebook.png" alt=""></a></li>
					<li><a class="m_hatena"
							href="https://b.hatena.ne.jp/add?mode=confirm&url=https://example.com/search/a/&title=「タイトル」の検索結果"
							rel="nofollow" target="_blank"><img src="img/icon-hatena.png" alt=""></a></li>
					<li><a class="m_line" href="https://social-plugins.line.me/lineit/share?url=https://example.com/search/a/"
							rel="nofollow" target="_blank"><img src="img/icon-line.png" alt=""></a></li>
					<li><a class="m_pocket" href="https://getpocket.com/edit?url=https://example.com/search/a/" rel="nofollow"
